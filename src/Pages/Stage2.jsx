...
const Stage2 = () => {
  return (
    <div className='flex justify-center items-center m-auto '> 
       <div className="bg-white rounded-lg mt-10 pb-10 mb-10 w-[30rem] lg:w-[45rem] md:w-[30rem] sm:[25rem] ">
      ...
      <div className="bg-slate-100 rounded-lg p-3 pb-10 ml-3 w-[19rem] lg:w-[43rem]">
         <div className="">
         ...
         <label htmlFor="number " className='font-bold'>Card Number<br/>
          ...
          className='lg:w-[20rem] md:w-[20rem] sm-[18rem] w-[17rem] mt-2 p-3 rounded-xl bg-white'
          />
         </label>
         </form>
        </div>
